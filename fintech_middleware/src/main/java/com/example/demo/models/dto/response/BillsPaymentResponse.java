...
public class BillsPaymentResponse {
  ...
  public static BillsPaymentResponse fromEntity(BillsPayment entity, BillsPaymentRequest request){
    return BillsPaymentResponse.builder()
        ...
        .billerName(entity.getProduct() != null ? entity.getProduct().getBiller() : BillerEnum.valueOf(request.getBiller().toUpperCase()))
        .billsCategory(entity.getProduct() != null ? entity.getCategory() : VasCategory.valueOf(request.getCategory().toUpperCase()))
